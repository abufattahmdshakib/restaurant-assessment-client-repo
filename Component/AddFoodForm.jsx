...
export default function AddFoodForm({
    ...
    const handleAddFood = async (e) => {
        e.preventDefault();
        if (!foodForm.name || !foodForm.category || !foodForm.price || !foodForm.rating || !foodForm.img) {
                ...
                <form onSubmit={handleAddFood} className="flex flex-col gap-3 transition-all duration-300">
                    ...
                    {foodForm.img && (
                        <img
                            ...
                            alt="Preview"
                            className="w-20 h-20 object-cover rounded mt-1 border mx-auto transition-all duration-300"
                        />
                    )}
